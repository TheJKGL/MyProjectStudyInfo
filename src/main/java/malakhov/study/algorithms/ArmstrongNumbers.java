...
//Число S состоит из M цифр, например, S=370 и M (количество цифр) = 3 Реализовать логику метода getNumbers,
...
//Пример искомого числа: 370 = 3*3*3 + 7*7*7 + 0*0*0 8208 = 8*8*8*8 + 2*2*2*2 + 0*0*0*0 + 8*8*8*8
